...
{s:"전기기기", t:"변압기 3상 결선", crit:"변압기",
 ...
 pts:["Y결선은 중성점을 접지할 수 있어 이상전압에 유리",
      "Δ결선이 제3고조파 통로를 만들어 장해가 작다 → 파형이 좋아진다",
      "Δ-Y·Y-Δ 결선은 1·2차 전압에 위상차 30°(π/6 rad)가 생긴다 (출제 포인트)",
...
{s:"전기기기", t:"3상 유도전동기 기동법", crit:"유도전동기",
 f:"Y-Δ 기동: 기동전류 1/3, 기동토크 1/3 · 농형/권선형 기동법 구분이 시험 포인트",
 pts:["농형: 전전압(직입) · Y-Δ · 리액터 · 1차 저항 · 기동보상기(단권변압기) 기동법",
      "권선형: 2차 저항 기동법(기동저항기법) — 비례추이를 이용",
      "Y-Δ 기동: 처음엔 Y로 걸어 전류를 1/3로 낮추고, 속도가 오르면 Δ로 전환",
      "용량 기준(일반적): 전전압 5kW 이하 · Y-Δ 5~15kW · 기동보상기 15kW 초과"],
 svg:`<svg viewBox="0 0 440 220" xmlns="http://www.w3.org/2000/svg">
  <rect width="440" height="220" fill="#fff"/>
