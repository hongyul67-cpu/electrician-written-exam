...
{s:"전기설비", t:"전선관 공사의 종류", crit:"배선설비공사 및 전선허용전류",
 f:"후강 = 안지름(내경)에 가까운 짝수 10종(16·22·28·36·42·54·70·82·92·104) · 박강 = 바깥지름(외경)에 가까운 홀수 7종(19·25·31·39·51·63·75)",
 pts:["금속관: 튼튼하고 기계적 보호 우수 (후강·박강으로 구분)",
      "후강은 두껍고 안지름 기준 짝수, 박강은 두께 1.2mm로 얇고 바깥지름 기준 홀수",
      "합성수지관: 가볍고 부식에 강함 · 두께 2.0mm 이상 · 지지점 간 거리 1.5m 이하",
...
{s:"전기설비", t:"가공전선로 장주 (전주 세우기)", crit:"가공인입선 및 배전선 공사",
 f:"발판 볼트: 지표상 1.8m부터 완금 하부 0.9m까지 · 7m 전주 매설 1.2m 이상",
 pts:["완금(암)에 애자를 달고 전선을 지지한다",
      "발판 볼트는 지표상 1.8m 이상 높이부터 설치 (아이들 오르기 방지)",
      "지지선(지선): 소선 2.6mm 이상 아연도금 연선 3가닥 이상을 꼬아서 사용",
      "지지선 안전율 2.5 이상 · 허용 인장하중 4.31[kN] 이상 (자주 출제!)"],
 svg:`<svg viewBox="0 0 440 250" xmlns="http://www.w3.org/2000/svg">
  <rect width="440" height="250" fill="#fff"/>
