...
{s:"전기이론", t:"옴의 법칙", crit:"직류회로", f:"V = I × R,  I = V / R,  R = V / I",
 ...
 svg:`<svg viewBox="0 0 420 210" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M100 58 H310" stroke="#1e293b" stroke-width="3" fill="none"/>
  <path d="M310 58 V80" stroke="#1e293b" stroke-width="3" fill="none"/>
  <path d="M310 130 V152" stroke="#1e293b" stroke-width="3" fill="none"/>
  <path d="M310 152 H100" stroke="#1e293b" stroke-width="3" fill="none"/>
  <path d="M100 152 V131" stroke="#1e293b" stroke-width="3" fill="none"/>
  <path d="M100 79 V58" stroke="#1e293b" stroke-width="3" fill="none"/>
  ...
  <path d="M172 36 H236" stroke="#0891b2" stroke-width="3.5" fill="none"/>
...
{s:"전기이론", t:"직렬 접속 · 병렬 접속", crit:"직류회로",
 ...
 svg:`<svg viewBox="0 0 440 250" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M170 200 V240" stroke="#1e293b" stroke-width="3" fill="none"/>
  <path d="M300 200 V240" stroke="#1e293b" stroke-width="3" fill="none"/>
...
{s:"전기이론", t:"콘덴서(정전용량)", crit:"전기의 성질과 전하에 의한 전기장",
 ...
 svg:`<svg viewBox="0 0 420 210" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M140 70 H195 M140 95 H195 M140 120 H195 M140 145 H195" stroke="#94a3b8" stroke-width="2" stroke-dasharray="6 4" fill="none"/>
  ...
  <path d="M60 180 H290" stroke="#1e293b" stroke-width="3" fill="none"/>
  ...
  <path d="M166 55 V160" stroke="none" fill="none"/>
  <path d="M132 105 h68" stroke="#16a34a" stroke-width="0" fill="none"/>
 </svg>`},
...
{s:"전기이론", t:"전류가 만드는 자기장 (오른나사 법칙)", crit:"자기의 성질과 전류에 의한 자기장",
 ...
 svg:`<svg viewBox="0 0 420 220" xmlns="http://www.w3.org/2000/svg">
  <rect width="420" height="220" fill="#fff"/>
  <path d="M160 200 V34" stroke="#1e293b" stroke-width="6" fill="none"/>
  ...
  <path d="M160 130 H250" stroke="#64748b" stroke-width="1.5" stroke-dasharray="5 4" fill="none"/>
...
{s:"전기이론", t:"플레밍의 왼손·오른손 법칙", crit:"전자력과 전자유도",
 ...
 svg:`<svg viewBox="0 0 440 230" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(20,36)">
    ...
    <path d="M18 70 H140" stroke="#2563eb" stroke-width="2" stroke-dasharray="6 4" fill="none"/>
    ...
    <path d="M78 74 V44" stroke="#dc2626" stroke-width="4" fill="none"/>
  ...
  <g transform="translate(250,36)">
    ...
    <path d="M18 70 H140" stroke="#16a34a" stroke-width="2" stroke-dasharray="6 4" fill="none"/>
    <text x="34" y="64" font-size="12" font-weight="700" fill="#16a34a">B</text>
    <circle cx="78" cy="86" r="11" fill="#fff" stroke="#1e293b" stroke-width="2.5"/>
    <path d="M72 86 H84" stroke="#0891b2" stroke-width="3" fill="none"/>
    <path d="M78 74 V44" stroke="#1e293b" stroke-width="4" fill="none"/>
...
{s:"전기이론", t:"전자유도 (패러데이 · 렌츠 법칙)", crit:"전자력과 전자유도",
 ...
 svg:`<svg viewBox="0 0 420 210" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M285 108 H254" stroke="#dc2626" stroke-width="3.5" fill="none"/>
...
{s:"전기이론", t:"정현파 교류 (최대값·실효값·평균값)", crit:"교류회로",
 ...
 svg:`<svg viewBox="0 0 440 220" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M40 110 H420" stroke="#94a3b8" stroke-width="2" fill="none"/>
  <path d="M50 20 V200" stroke="#94a3b8" stroke-width="2" fill="none"/>
  <path d="M50 110 q47 -95 94 0 t94 0 t94 0 t94 0" fill="none" stroke="#d97706" stroke-width="3.5"/>
  <path d="M50 40 H420" stroke="#dc2626" stroke-width="1.8" stroke-dasharray="7 5" fill="none"/>
  <text x="380" y="34" font-size="13" font-weight="700" fill="#dc2626">최대값 Vm</text>
  <path d="M50 61 H420" stroke="#16a34a" stroke-width="1.8" stroke-dasharray="7 5" fill="none"/>
  <text x="360" y="76" font-size="13" font-weight="700" fill="#16a34a">실효값 0.707Vm</text>
  <path d="M50 65 H160" stroke="none" fill="none"/>
  <text x="112" y="206" font-size="12.5" text-anchor="middle" fill="#64748b">1주기 (T)</text>
  <path d="M50 190 H144" stroke="#64748b" stroke-width="1.5" fill="none"/>
  <path d="M50 186 V194 M144 186 V194" stroke="#64748b" stroke-width="1.5" fill="none"/>
...
{s:"전기이론", t:"3상 Y결선 · Δ결선", crit:"교류회로",
 ...
 svg:`<svg viewBox="0 0 440 230" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(20,30)">
    ...
    <path d="M100 100 L100 40 M100 100 L48 130 M100 100 L152 130" stroke="#d97706" stroke-width="4" fill="none"/>
